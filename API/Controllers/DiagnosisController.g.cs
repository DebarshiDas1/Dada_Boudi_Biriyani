...
namespace DadaBoudiBiriyani.Controllers
{
    ...
    public class DiagnosisController : BaseApiController
    {
        ...
        [HttpGet]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<Diagnosis>))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [Produces("application/json")]
        [UserAuthorize("Diagnosis", Entitlements.Update)]
        public async Task<IActionResult> PatchById(Guid id, [FromBody] JsonPatchDocument<Diagnosis> updatedEntity)
        {
