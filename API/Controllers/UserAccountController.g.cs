...
namespace DadaBoudiBiriyani.Controllers
{
    ...
    public class UserAccountController(IUserAuthenticationService _userAuthenticationService) : Controller
    {
        ...
        public IActionResult Register([FromBody] RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (!model.Password.Equals(model.ConfirmPassword))
                    return BadRequest(ExceptionFormatter.ErrorMessage("Password and confirm-password does not match."));
                ...
                {
                    return BadRequest(ExceptionFormatter.ErrorMessage("Email or userName is already taken."));
                }
            }

            return BadRequest(ExceptionFormatter.ErrorMessage("Invalid model data."));
        }
        ...
        public IActionResult Login([FromBody] LoginModel model)
        {
            ...
            return BadRequest(ExceptionFormatter.ErrorMessage("Invalid model."));
        }
